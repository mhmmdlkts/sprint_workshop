...
(function() {
  var fields, he, key, manifest, preload, setPart, val;
  ...
  preload.onComplete = function() {
    ...
    return socket.on('stage init', function(ini) {
      var cell, id, info, row, x, y, _base, _base1, _ref, _ref1, _ref2;
      console.log(ini);
      he["static"].objmap = [];
      he.flow.objmap = [];
      he.flow.chars = {};
